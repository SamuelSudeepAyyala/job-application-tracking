...
- Create Angular project with ng: `ng new job-application-tracking.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`job-application-tracking.client.esproj`).
